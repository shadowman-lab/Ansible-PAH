...
An Ansible role for build aristaee.
...
* **dest_dir**: Variable used in: Create the directory if it does not exist
  - Default: `/home/ansible/ansible/builder/aristaee/`
...
* **galaxy_requirements_file**: Configuration parameter for build_aristaee
...
* **ee_python_interpreter**: Configuration parameter for build_aristaee
  - Default: `{'python_path': '/usr/bin/python3.12'}`

* **ee_build_files**: Configuration parameter for build_aristaee
  - Default: `[{'src': '/home/ansible/ansible/builder/aristaee/ansible.cfg', 'dest': 'configs'}]`

* **ee_collections**: Configuration parameter for build_aristaee
  - Default: `[{'name': 'arista.avd'}]`

* **ee_prepend_galaxy**: Configuration parameter for build_aristaee
