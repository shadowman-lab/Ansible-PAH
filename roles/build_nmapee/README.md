...
An Ansible role for build nmapee.
...
* **dest_dir**: Variable used in: Create the directory if it does not exist
  - Default: `/home/ansible/ansible/builder/nmapee/`
...
* **galaxy_requirements_file**: Configuration parameter for build_nmapee
...
* **ee_python_interpreter**: Configuration parameter for build_nmapee
  - Default: `{'python_path': '/usr/bin/python3.12'}`

* **ee_build_files**: Configuration parameter for build_nmapee
  - Default: `[{'src': '/home/ansible/ansible/builder/nmapee/ansible.cfg', 'dest': 'configs'}]`

* **ee_bindep**: Binary path
  - Default: `['nmap [platform:rpm]', 'sudo [platform:rpm]']`

* **ee_collections**: Configuration parameter for build_nmapee
  - Default: `[{'name': 'community.general'}, {'name': 'ansible.windows'}, {'name': 'servicenow.itsm'}]`

* **ee_prepend_galaxy**: Configuration parameter for build_nmapee
