...
An Ansible role for build securityee.
...
* **dest_dir**: Variable used in: Create the directory if it does not exist
  - Default: `/home/ansible/ansible/builder/securityee/`
...
* **galaxy_requirements_file**: Configuration parameter for build_securityee
...
* **ee_python_interpreter**: Configuration parameter for build_securityee
  - Default: `{'python_path': '/usr/bin/python3.12'}`

* **ee_build_files**: Configuration parameter for build_securityee
  - Default: `[{'src': '/home/ansible/ansible/builder/securityee/ansible.cfg', 'dest': 'configs'}]`

* **ee_collections**: Configuration parameter for build_securityee
  - Default: `[{'name': 'ansible.windows'}, {'name': 'community.crypto'}, {'name': 'community.general'}, {'name': 'ibm.qradar'}, {'name': 'paloaltonetworks.panos'}, {'name': 'shadowman.reports'}]`

* **ee_prepend_galaxy**: Configuration parameter for build_securityee
